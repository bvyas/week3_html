...
define('DB_DATABASE', 'login_demo'); //make sure to set your database
...
//time difference check between now & time provided
function check_time($date_to_check)
{
    // needed to set time prior to OS reload seems to be inserting correctly without now!
    // date_default_timezone_set("America/Los_Angeles");
    $date_time_now=strtotime(Date("Y-m-d H:i:s"));
    $time_diff_allowed=(($date_time_now-$date_to_check)<1800);
    return $time_diff_allowed;
}
?>