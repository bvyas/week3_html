...
<body>
	...
	<div class="Register">
		<h4>Register</h4>
	<form action='/friends/signup_validation' method='post'>
		 Name<input type="text" name="name"><br>
		<br>Alias<input type="text" name="alias"><br>
		<br>Email<input type="text" name="email"><br>
		<br>Password<input type="password" name="password">
		<h6>*Password should be at least 8 characters</h6>
		<br>CPassword<input type="password" name="cpassword"><br>
		<br>Date of Birth<input type="date" name="Date of Birth">
	...
	<div class="Login">
		<h4>Login</h4>
	<form action='/friends/process' method='post'>
